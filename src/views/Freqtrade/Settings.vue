      ...
      <div class="container mt-3">
        <b-card header="FreqUI Settings">
          <div class="text-start">
            ...
            >
              <b-form-checkbox v-model="layoutStore.layoutLocked"
                >Lock layout</b-form-checkbox
              >
            </b-form-group>
            <b-form-group description="Reset dynamic layouts to how they were.">
              <b-button size="sm" @click="resetDynamicLayout"
                >Reset layout</b-button
              >
            </b-form-group>
            <b-form-group
            ...
            <b-form-group
              description="Keep background sync running while other bots are selected."
            >
            ...
            <b-form-group description="Notifications">
              <b-form-checkbox
                v-model="
                  settingsStore.notifications[FtWsMessageTypes.entryFill]
                "
                >Entry notifications</b-form-checkbox
              >
              <b-form-checkbox
                v-model="settingsStore.notifications[FtWsMessageTypes.exitFill]"
                >Exit notifications</b-form-checkbox
              >
              <b-form-checkbox
                v-model="
                  settingsStore.notifications[FtWsMessageTypes.entryCancel]
                "
                >Entry Cancel notifications</b-form-checkbox
              >
              <b-form-checkbox
                v-model="
                  settingsStore.notifications[FtWsMessageTypes.exitCancel]
                "
...
const openTradesOptions = [
  ...
  {
    value: OpenTradeVizOptions.noOpenTrades,
    text: "Don't show open trades in header",
  },
];
