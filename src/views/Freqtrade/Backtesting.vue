<template>
  <ion-page>
    <ion-header>
      <ion-toolbar>
        <ion-title>Backtesting</ion-title>
      </ion-toolbar>
    </ion-header>
      ...
      <div class="container-fluid" style="max-height: calc(100vh - 60px)">
        ...
        <div class="d-md-flex">
          ...
          <div
            ...
            } sticky-top sticky-offset me-3 d-flex flex-column`"
          >
            <b-button
  ...
  () => {
    if (botStore.activeBot.backtestRunning === true) {
      pollInterval.value = window.setInterval(
        botStore.activeBot.pollBacktest,
        1000
      );
